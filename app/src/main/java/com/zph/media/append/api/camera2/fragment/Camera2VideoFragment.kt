...
import com.zph.media.append.api.camera2.AutoFitTextureView
...
class Camera2VideoFragment : Fragment(), View.OnClickListener,
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        videoButton = view.findViewById<Button>(R.id.btn_record_view).also {
...
//        view.findViewById<View>(R.id.info).setOnClickListener(this)
    ...
    override fun onClick(view: View) {
        when (view.id) {
            R.id.btn_record_view -> if (isRecordingVideo) stopRecordingVideo() else startRecordingVideo()
//            R.id.info -> {
//                if (activity != null) {
...
//                .show(childFragmentManager, FRAGMENT_DIALOG)
    ...
    private fun stopRecordingVideo() {
        ...
        videoButton.text = "R.string.record"
        mediaRecorder?.apply {
            stop()
            reset()
        }
    ...
    companion object {
        fun newInstance(): Camera2VideoFragment =
